...
try:
    ...
    MONGODB_URI = os.getenv("MONGODB_URI", "MONGODB_URI=mongodb+srv://elisarrtech:R_zeHWhW9iAhYyM@cluster0.yjot3u0.mongodb.net/fitnessclubdb?retryWrites=true&w=majority&appName=Cluster0")
